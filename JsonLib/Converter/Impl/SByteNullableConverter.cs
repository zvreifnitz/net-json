...
{
    internal sealed class SByteNullableConverter : ConverterBase<sbyte?>
    {
        ...
        public override void FromJson(IJsonSerializators context, IJsonReader reader, out sbyte? instance)
        {
            ...
            if (token == JsonToken.Null)
            {
                instance = null;
                     ...
                     sbyte.TryParse(reader.ReadValue(), IntegerNumberStyle, DefaultCultureInfo, out sbyte parsed))
            {
                instance = parsed;
            }
            else
