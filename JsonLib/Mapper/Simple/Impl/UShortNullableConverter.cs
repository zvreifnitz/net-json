...
{
    internal sealed class UShortNullableConverter : ConverterBase<ushort?>
    {
        ...
        public override void FromJson(IJsonSerializators context, IJsonReader reader, out ushort? instance)
        {
            ...
            if (token == JsonToken.Null)
            {
                instance = null;
                     ...
                     ushort.TryParse(reader.ReadValue(), IntegerNumberStyle, DefaultCultureInfo, out ushort parsed))
            {
                instance = parsed;
            }
            else
