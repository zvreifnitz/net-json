...
namespace com.github.zvreifnitz.JsonLib.Mapper.Simple.Impl
{
    ...
    internal sealed class BigIntegerNullableConverter : ConverterBase<BigInteger?>
    {
        public override void ToJson(IJsonSerializators context, IJsonWriter writer, BigInteger? instance)
        {
