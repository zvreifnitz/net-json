...
namespace com.github.zvreifnitz.JsonLib.Mapper.Simple.Impl
{
    ...
    {
        public override void ToJson(IJsonContext context, IJsonWriter writer, float instance)
        {
            writer.WriteRaw(instance.ToString(DefaultCultureInfo));
        }

        public override void FromJson(IJsonContext context, IJsonReader reader, out float instance)
        {
