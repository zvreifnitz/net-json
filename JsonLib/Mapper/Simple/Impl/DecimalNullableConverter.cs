...
{
    internal sealed class DecimalNullableConverter : ConverterBase<decimal?>
    {
        ...
        public override void FromJson(IJsonSerializators context, IJsonReader reader, out decimal? instance)
        {
            ...
            if (token == JsonToken.Null)
            {
                instance = null;
                     ...
                     decimal.TryParse(reader.ReadValue(), FloatNumberStyle, DefaultCultureInfo, out decimal parsed))
            {
                instance = parsed;
            }
            else
